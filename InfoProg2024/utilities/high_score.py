...
class HighScore:
    """
    A ranklista adat struktúrája:
    - rank: int -- hagyadik helyen van, végülis a sorszáma a fájlban
    - name: str -- a játékos neve, vagy gép esetén a CPU szó
    - score: int - pontszám
    """
    rank: int
    name: str
...
def save_high_scores(high_scores, filename="high_scores.csv") -> None:
    """
    Az első highscore-t menti el
    """
...
if __name__ == "__main__":
    # test
    high_scores_1 = [HighScore(1, "Bob", 85),
                     HighScore(2, "Bob", 80),
                     HighScore(3, "Ross", 63),
                     HighScore(4, "Karl", 61),
                     HighScore(5, "CPU", 60),
    ...
    save_high_scores(high_scores_1)
